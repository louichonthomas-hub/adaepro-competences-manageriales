...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-950 via-blue-800 to-blue-600">
      {/* Hero Section */}
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 mb-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="p-6 bg-gradient-to-br from-blue-50 to-white rounded-xl border border-blue-100 hover:shadow-lg transition-shadow">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {[
                ...
                <div key={index} className="flex items-start gap-3 p-4 bg-gradient-to-r from-blue-50 to-white rounded-lg border border-blue-100">
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12 mb-8">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="flex gap-4 p-6 bg-gradient-to-br from-blue-50 to-white rounded-xl border border-blue-100">
